...
try {
            String sql = "INSERT INTO tbl_supplier (id_supplier, nama_supplier, no_telp, alamat) VALUES (?, ?, ?, ?)";
...
try {
            String sql = "UPDATE tbl_supplier SET nama_supplier=?, no_telp=?, alamat=? WHERE id_supplier=?";
            java.sql.Connection open_koneksi = KoneksiPenjualan.configDB();
            java.sql.PreparedStatement pst = open_koneksi.prepareStatement(sql);
...
try {
            String sql = "DELETE FROM tbl_supplier WHERE id_supplier='" + txtId.getText() + "'";
            java.sql.Connection open_koneksi = KoneksiPenjualan.configDB();
            java.sql.PreparedStatement pst = open_koneksi.prepareStatement(sql);
...
int baris = tblSupplier.rowAtPoint(evt.getPoint());
        ...
        String id = tblSupplier.getValueAt(baris, 0).toString();
        txtId.setText(id);
        
        String nama = tblSupplier.getValueAt(baris, 1).toString();
        txtNama.setText(nama);
        
        String telp = tblSupplier.getValueAt(baris, 2).toString();
